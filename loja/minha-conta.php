...
<script>
      function editar() {
        ...
        xmlhttp.open("POST", "sys/cadastros.php?type=editar", true);
      ...
      function cadastrarprod() {
        ...
        xmlhttp.open("POST", "sys/cadastros.php?type=cadastrarprod", true);
        xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xmlhttp.send("nome=" + nome + "&imagem=" + imagem + "&descricao=" + descricao + "&valor=" + valor);
      }
  </script>
    <!--[if lte IE 9]>
                    ...
                    <div class="axil-dashboard-author">
                        <div class="media">
                            <div class="media-body">
                                <h5 class="title mb-0">Olá <?php echo $_SESSION['nome']; ?></h5>
                                <span class="joining-date">Seja Bem-Vindo(a)</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <aside class="axil-dashboard-aside">
                                <nav class="axil-dashboard-nav">
                                    <div class="nav nav-tabs" role="tablist">
                                        <a class="nav-item nav-link active" data-bs-toggle="tab" href="#nav-dashboard" role="tab" aria-selected="true"><i class="fas fa-th-large"></i>Alterar Meus Dados</a>
                                        <a class="nav-item nav-link" data-bs-toggle="tab" href="#nav-orders" role="tab" aria-selected="false"><i class="fas fa-shopping-basket"></i>Adicionar Produto</a>
                                        <a class="nav-item nav-link" data-bs-toggle="tab" href="#nav-downloads" role="tab" aria-selected="false"><i class="fas fa-file-download"></i>Editar Produto</a>
                                        <a class="nav-item nav-link" href="logout.php"><i class="fal fa-sign-out"></i>Logout</a>
                                    </div>
                                </nav>
                            </aside>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="nome" value="<?php echo $_SESSION['nome']; ?>" placeholder="Seu Nome">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label>Seu Usuário</label>
                                                            <input type="text" class="form-control" value="<?php echo $_SESSION['usuario']; ?>" id="usuario" placeholder="Seu Usuário">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label>Email</label>
                                                            <input type="email" class="form-control" value="<?php echo $_SESSION['email']; ?>" id="email" placeholder="email@exemplo.com">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Senha</label>
                                                        ...
                                                        <div class="form-group mb--0">
                                                            <input type="button" onclick="editar()" class="axil-btn" value="Salvar">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                            ...
                                            <table class="table">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="editar-produto.php?id=<?php echo $show['ID_prd']; ?>" class="axil-btn view-btn" style="margin-right:10px;">Editar</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>    
